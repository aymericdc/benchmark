...
int main()
{
    ...
    //    writeVBenchmark(1, buf,t,writev_rec); writeVBenchmark(5, buf,t,writev_rec); writeVBenchmark(10, buf,t,writev_rec); writeVBenchmark(25, buf,t,writev_rec); writeVBenchmark(50, buf,t,writev_rec); writeVBenchmark(75, buf,t,writev_rec); writeVBenchmark(100, buf,t,writev_rec); writeVBenchmark(200, buf,t,writev_rec); writeVBenchmark(300, buf,t,writev_rec); writeVBenchmark(400, buf,t,writev_rec); writeVBenchmark(500, buf,t,writev_rec); writeVBenchmark(600, buf,t,writev_rec); writeVBenchmark(700, buf,t,writev_rec); writeVBenchmark(800, buf,t,writev_rec); writeVBenchmark(900, buf,t,writev_rec); writeVBenchmark(1000, buf,t,writev_rec); writeLseekBenchmark(1, buf,t,writelseek_rec); writeLseekBenchmark(5, buf,t,writelseek_rec); writeLseekBenchmark(10, buf,t,writelseek_rec); writeLseekBenchmark(25, buf,t,writelseek_rec); writeLseekBenchmark(50, buf,t,writelseek_rec); writeLseekBenchmark(75, buf,t,writelseek_rec); writeLseekBenchmark(100, buf,t,writelseek_rec); writeLseekBenchmark(200, buf,t,writelseek_rec); writeLseekBenchmark(300, buf,t,writelseek_rec); writeLseekBenchmark(400, buf,t,writelseek_rec); writeLseekBenchmark(500, buf,t,writelseek_rec); writeLseekBenchmark(600, buf,t,writelseek_rec); writeLseekBenchmark(700, buf,t,writelseek_rec); writeLseekBenchmark(800, buf,t,writelseek_rec); writeLseekBenchmark(900, buf,t,writelseek_rec); writeLseekBenchmark(1000, buf,t,writelseek_rec);
